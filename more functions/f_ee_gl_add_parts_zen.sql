-- DROP FUNCTION meta_info.f_ee_gl_add_parts_zen(int4);

CREATE OR REPLACE FUNCTION meta_info.f_ee_gl_add_parts_zen(p_id int4)
	RETURNS varchar
	LANGUAGE plpgsql
	VOLATILE
AS $$
...
ALTER FUNCTION meta_info.f_ee_gl_add_parts_zen(int4) OWNER TO drp;
GRANT ALL ON FUNCTION meta_info.f_ee_gl_add_parts_zen(int4) TO public;
GRANT ALL ON FUNCTION meta_info.f_ee_gl_add_parts_zen(int4) TO drp;
